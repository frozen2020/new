...
void Initialize()
{
	...
	*/
    *MCRC = 0x0C21; /* iope1 rf driver power control */
	/* group C pins:
	   0=CLKOUT 1=PWM7 2=IOPE2 3=IOPE3 4=IOPE4 5=PWM11 6=IOPE6 7=IOPE7
	...
	//FPS//
		...
		port00 = 0x000F;
	 	...
	 	num2ascii(LASSET, 0);
			...
			else if (FUNCTION == 10)			// CRYSTAL1 TEMPERATURE
	 	{
	 	message(msg32);
		PLACE=64;
		message(msg33);
...
//rev6		num2ascii(DIODECUR2,0);
	...
	if(SIGN_FUN8SET==4)
		...
		else if (FUNCTION == 4) 
		{
			...
			{PLACE = 17;
			num2ascii(POS_OLD, 8);  	
			if((POS_NEW>0 )&&(POS_NEW<7))
			PLACE= 66+ (POS_NEW-1)*3;
			else if((POS_NEW>6 )&&(POS_NEW<13))
			PLACE= 22+ (POS_NEW-7)*3;
			wait(20);
				port00 = PLACE+128;
	 			wait(20);
	 			port00=0x000F;  //turn off cursor and blink 
		...
		wait(20);
	   	if((FUNCTION!=2) && (FUNCTION!=8)&& (FUNCTION!=9)&& (FUNCTION != 10))       
		{	
   				PLACE=39;
	 			port00 = PLACE+128;
	 			wait(20);
