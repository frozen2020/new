...
char msg32[]= " Picmotor Status     07 08 09 10 11 12 ";
char msg33[]= " 01 02 03 04 05 06   ";
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
unsigned short QSWEXT, SHTON, RESET, PLACE, BEEPER, BTIME, KEY,LOOP,MOTORSTART,MOTORCOUNT;
...
short ENVACT, ENVSET, XTL1ACT, XTL1SET, XTL2ACT, XTL2SET,POS_OLD,POS_NEW;
//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
char chr; 
char HOLD[6];
long DspTmr;
...
short clearWarning;
//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
unsigned short SIGN_FUN8SET, SIGN_FUN12SET, securityenable,SecurityIniting;
